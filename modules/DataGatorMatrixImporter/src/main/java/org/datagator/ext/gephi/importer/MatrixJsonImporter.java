    ...
    implements FileImporter, LongTask
{
    ...
    public boolean execute(ContainerLoader loader)
    {
        ...
        try {
            ...
            EdgeDirectionDefault edgeType
                = (isDirected) ? EdgeDirectionDefault.DIRECTED : EdgeDirectionDefault.UNDIRECTED;
        ...
        throws IOException
    {
        ...
        while (token.equals(JsonToken.START_ARRAY)) {
            ...
            if (container.nodeExists(sourceId)) {
                ...
                source = container.factory().newNodeDraft(sourceId);
            ...
            if (container.nodeExists(targetId)) {
                ...
                target = container.factory().newNodeDraft(targetId);
            ...
            if (container.edgeExists(edgeId)) {
                ...
                edge = container.factory().newEdgeDraft(edgeId);
            ...
            if (timeField != null) {
                edge.addInterval(dateFormat.format(start),
